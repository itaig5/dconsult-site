...
(function () {
  ...
  var HE = {
    ...
    "about.p1": "מאז 2016, D Consulting היא חברה מובילה בפיתוח עסקי וחדשנות עבור תעשיית האירוח — ומסייעת לבתי אירוח להפוך את ערוצי המכירה המקוונים למנוע צמיחה אמיתי ומדיד.",
    ...
    "results.s3": "שווקים: ישראל · קפריסין · יוון · בריטניה",
